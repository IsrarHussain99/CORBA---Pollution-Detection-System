 ...
 * Selecting another arbitrary username will show only the latest AlarmClass recorded by a LMC in a specified zone.
...
public class RMCClient extends JFrame {
	...
	try {
		...
		//USER ACCOUNTS AND CREATION SYSTEM. THIS ENSURES THE RMC HAS A USER ACCOUNT OPERATING IT.
		//
		//
		// (NOT REQUIRED I THINK_)
	    		...
	    		public void actionPerformed(ActionEvent evt) {
	    			...
	    			if(rmc.checkUser(userID) == true){ //if the user is an agency, retrieve a list of all alarms in this zone
	    				...
	    				for(int i = 0; i< alarmLog.length; i++){
	    					...
	    					textarea.append("AlarmClass on the_date " + thisAlarm.the_date + " at the_time " + thisAlarm.the_time + "\n");
	    					textarea.append("\"" + thisAlarm.sensorString + "\" triggered an alarm.\n");
	    					textarea.append("Sensor 1 level: " + thisAlarm.sensor_level1 + " Sensor 2 level: " + thisAlarm.sensor_level2 + "\n");
	    					textarea.append("---\n");
	    					} 
	    					...
	    					AlarmClass thisAlarm = new AlarmClass();
	    					...
	    					textarea.append("\"" + thisAlarm.sensorString + "\" triggered an alarm.\n");
	    					textarea.append("Sensor 1 level: " + thisAlarm.sensor_level1 + " Sensor 2 level: " + thisAlarm.sensor_level2 + "\n");
		    				textarea.append("AlarmClass sent to registered Agencies? - " + isResolved + "\n");
	    				}
