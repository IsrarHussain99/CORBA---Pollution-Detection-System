...
public abstract class AllAlarmListHelper
{
	...
	{
		return "IDL:RMCentre/AllAlarmList:1.0";
	}
	public static LMCentre.AlarmClass[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new LMCentre.AlarmClass[_l_result3];
